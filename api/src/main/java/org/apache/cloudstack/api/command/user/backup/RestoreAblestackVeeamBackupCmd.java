...
public class RestoreAblestackVeeamBackupCmd extends BaseAsyncCmd {
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException,
        ...
        try {
            ...
            if (result) {
                ...
                throw new CloudRuntimeException("Failed to restore Ablestack Veeam backup");
            }
        } catch (Exception e) {
    ...
    public String getEventDescription() {
        return "Restoring Instance from Ablestack Veeam backup ID: " + getResourceUuid(ApiConstants.ID);
    }
}
