       ...
       >
        ...
        <div v-if="form.protocol === 'Linstor' || form.provider === 'Linstor'">
          ...
          <a-form-item name="linstorApiToken" ref="linstorApiToken">
            ...
            <a-input-password v-model:value="form.linstorApiToken" :placeholder="$t('message.linstor.apitoken.description')" />
          </a-form-item>
...
export default {
  ...
  methods: {
    ...
    fetchHypervisor (value) {
      ...
      this.hypervisorType = cluster.hypervisortype
      if (this.hypervisorType === 'KVM') {
        this.protocols = ['Glue Block', 'Glue FileSystem', 'nfs', 'SharedMountPoint', 'RBD', 'CLVM', 'CLVM_NG', 'Gluster', 'Linstor', 'custom', 'FiberChannel']
